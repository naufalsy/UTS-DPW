...
<html lang="en">
  ...
  <body id="beranda-page" >
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-info fixed-top"  id="navbar-Beranda">
        <div class="container">
        <nav>
            <a href="Beranda.php"><img src="LOGO.png" width="150" height="50" alt="web"></a>
        </nav>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item active">
                <a class="nav-link js-scroll-trigger" href="Kuis.html">KUIS <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item active">
